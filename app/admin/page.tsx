...
export default async function AdminPage() {
  ...
  return (
    <main className="admin-shell">
      <header className="admin-topbar"><div><Link href="/"><ArrowLeft size={17} />返回档案馆</Link><h1>Notion 同步</h1></div><form action="/api/auth/logout" method="post"><button type="submit" className="logout-button">退出登录</button></form></header>
