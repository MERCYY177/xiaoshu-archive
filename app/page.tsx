  ...
  return (
    <main className="archive-shell">
      <header className="topbar">
        ...
        <nav className="topnav" aria-label="主导航"><Link href="/">档案首页</Link><Link href="/browse">完整目录</Link><Link href="/admin" className="manage-link">同步</Link></nav>
      </header>
      ...
      <section className="content-section">
        {q && <div className="section-title"><div><span>搜索结果</span><strong>{pages.length}</strong></div><Link href="/">清除搜索</Link></div>}
        {unavailable ? (
